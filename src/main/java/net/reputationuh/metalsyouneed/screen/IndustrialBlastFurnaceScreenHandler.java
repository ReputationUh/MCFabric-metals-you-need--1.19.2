...
//    private final BlockEntity IndustrialBlastFurnaceBlockEntity;
    ...
    public IndustrialBlastFurnaceScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate delegate) {
        super(ModScreenHandlers.INDUSTRIAL_BLAST_FURNACE_SCREEN_HANDLER, syncId);
